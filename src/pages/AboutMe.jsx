        ...
        <div className="flex flex-col xs:flex-row xs:items-start xs:justify-center gap-4 w-full md:w-[80%] xs:w-[85%] items-center md:gap-x-[2.5rem] xs:gap-x-[clamp(1rem, 2vw + 1rem, 3.25rem)]">
          ...
          <div className="flex flex-row xs:flex-col items-center gap-x-[1rem] xs:gap-y-[0.5rem]">
            ...
            <div className="flex flex-col items-center mt-0 md:mt-[1rem] xs:mt-[0.25rem] xs:w-full w-[118px]">
              <div className="font-medium text-shade-of-white mb-[0.5rem] md:text-[1.5rem] text-[0.75rem]">Efficient</div>
              <div className="text-center text-shade-of-white font-normal md:leading-[1.875rem] md:tracking-[0.04rem] md:text-[1rem] xs:leading-[1rem] xs:tracking-[0] text-[0.5rem] leading-[0.75rem]">
          ...
          <div className="flex flex-row xs:flex-col items-center gap-x-[1rem] xs:gap-y-[0.5rem]">
            ...
            <div className="flex flex-col items-center mt-0 md:mt-[1rem] xs:mt-[0.25rem] xs:w-full w-[118px]">
              <div className="font-medium text-shade-of-white mb-[0.5rem] md:text-[1.5rem] text-[0.75rem]">Scalable</div>
              <div className="text-center text-shade-of-white font-normal md:leading-[1.875rem] md:tracking-[0.04rem] md:text-[1rem] xs:leading-[1rem] xs:tracking-[0] text-[0.5rem] leading-[0.75rem]">
          ...
          <div className="flex flex-row xs:flex-col items-center gap-x-[1rem] xs:gap-y-[0.5rem]">
            ...
            <div className="flex flex-col items-center mt-0 md:mt-[1rem] xs:mt-[0.25rem] xs:w-full w-[118px]">
              <div className="font-medium text-shade-of-white mb-[0.5rem] md:text-[1.5rem] text-[0.75rem]">Modular</div>
              <div className="text-center text-shade-of-white font-normal md:leading-[1.875rem] md:tracking-[0.04rem] md:text-[1rem] xs:leading-[1rem] xs:tracking-[0] text-[0.5rem] leading-[0.75rem]">
          ...
          <div className="flex flex-row xs:flex-col items-center gap-x-[1rem] xs:gap-y-[0.5rem]">
            ...
            <div className="flex flex-col items-center mt-0 md:mt-[1rem] xs:mt-[0.25rem] xs:w-full w-[118px]">
              <div className="font-medium text-shade-of-white mb-[0.5rem] md:text-[1.5rem] text-[0.75rem]">Robust</div>
              <div className="text-center text-shade-of-white font-normal md:leading-[1.875rem] md:tracking-[0.04rem] md:text-[1rem] xs:leading-[1rem] xs:tracking-[0] text-[0.5rem] leading-[0.75rem]">
